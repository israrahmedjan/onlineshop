    ...
    <div className="flex flex-1 items-center justify-end md:justify-between mt-4">
      <nav aria-label="Global" className="hidden md:block">
        ...
        <li>
          ...
          <li>
            <Link className="text-primary transition hover:text-secondary" href={process.env.NEXT_PUBLIC_DOMAIN+`category/electronics`}> Electronics </Link>
          </li>

          <li>
            <Link className="text-primary transition hover:text-secondary" href={process.env.NEXT_PUBLIC_DOMAIN+`category/home-appliances`}> Home Appliances </Link>
          </li>
          <li>
            <Link className="text-primary transition hover:text-secondary" href={process.env.NEXT_PUBLIC_DOMAIN+`category/mobile-phones`}> Mobile phones </Link>
          </li>
